package es.ieslosmontecillos.AppAgendaBE.JavaController;

import es.ieslosmontecillos.AppAgendaBE.entity.Persona;
import es.ieslosmontecillos.AppAgendaBE.JavaServices.PersonaService;
...
public class PersonaController {
    ...
    public ResponseEntity<Object> update(@RequestBody Persona persona,
        ...
        try {
            ...
            currentPersona.setId(persona.getId());
